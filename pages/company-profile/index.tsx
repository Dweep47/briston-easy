...
import TopHeader from "../components/company_profile/top_header";
import TeamSection from "../components/company_profile/team_section";
import ProfileSection from "../components/company_profile/profile_section";
  ...
  return (
    <>
      <Head>
       ...
       <title>Briston  | Leading Developer of Luxury Real Estate Projects</title>
